...
pub struct SetControlSurfaceDeflection {
    /// Message Header
    pub _header: Header,
...
impl Message for SetControlSurfaceDeflection {
    ...
    fn clear(&mut self) {
        self._header = Header::new(303);
        self._id = Default::default();
        self._angle = Default::default()
    }
    ...
    fn serialize_fields(&self, bfr: &mut bytes::BytesMut) {
        bfr.put_u8(self._id);
        bfr.put_f32_le(self._angle);
    }

    fn deserialize_fields(&mut self, bfr: &mut dyn bytes::Buf) -> Result<(), ImcError> {
        self._id = bfr.get_u8();
        self._angle = bfr.get_f32_le();
        Ok(())
    }
}
