...
pub struct TrexObservation {
    /// Message Header
    pub _header: Header,
    pub _timeline: String,
    pub _predicate: String,
    pub _attributes: String,
}
...
impl Message for TrexObservation {
    ...
    fn dynamic_serialization_size(&self) -> usize {
        ...
        dyn_size += self._attributes.len() + 2;
